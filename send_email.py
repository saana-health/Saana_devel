...
message = Mail(
    ...
    html_content='Hi <strong>' + to_name + "</strong>, \
    <br> <h1> Your personalize nutrition has just been calculated.</h1> \
    <p style = 'widht:200 px;'>Good News! Our team of scientists just finished up personalizing your next delivery of meals based on your latest medical information. \
    ...
    <br> <p style = 'width: 70%'>As always, don’t hesitate to contact us via text message (862) 256-3059 or email (hello@saana.co) for any questions regarding your meals,\
